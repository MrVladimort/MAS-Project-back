...
public class DbSeeder {
    ...
    public void loadData() {
        ...
        CommentEntity comment = CommentEntity.builder().text("Keks").grade(4).event(event).user(user2).build();
        CommentEntity comment2 = CommentEntity.builder().text("Keksik").grade(3).event(event2).user(user2).build();
        CommentEntity comment3 = CommentEntity.builder().text("Keksikulok").grade(5).event(event2).user(user).build();
